<?php 
   ...
   $db_name = 'mysql:host=localhost;dbname=ptcms_accounts';
   $db_user_name = 'root';
   $db_user_pass = '';
   ...
   $db_name = 'mysql:host=localhost;dbname=ptcms_logs';
   $db_user_name = 'root';
   $db_user_pass = '';

   $connForLogs = new PDO($db_name, $db_user_name, $db_user_pass);

   //DATABASE CONNECTION FOR conference

   $db_name = 'mysql:host=localhost;dbname=ptcms_conferenceData';
   $db_user_name = 'root';
   $db_user_pass = '';

   $connForConference = new PDO($db_name, $db_user_name, $db_user_pass);
?>